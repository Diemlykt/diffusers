...
@@ -907,9 +907,17 @@ def load_model_hook(models, input_dir):
        accelerator.register_save_state_pre_hook(save_model_hook)
        accelerator.register_load_state_pre_hook(load_model_hook)
...
@@ -975,9 +983,11 @@ def load_model_hook(models, input_dir):
    ...
    optimizer = optimizer_class(
        params_to_optimize,
        lr=args.learning_rate,
@@ -1216,8 +1226,13 @@ def compute_embeddings(batch, proportion_empty_prompts, text_encoders, tokenizer
